...
import { ShieldCheck, Zap, Clock, Download, Copy, Check, Info, Sparkles } from "lucide-react"; 
...
const TRANSLATIONS = {
  zh: {
    ...
    title1: "一键生成",
    title2: "小说 · 论文 · 绘图",
    subtitle: "输入想法，AI帮你写出高质量内容或画出大片",
    modeLabel: "创作类型",
    modes: [
      ...
      { id: "image", label: "🎨 绘图", desc: "Flux 顶级画质" },
    ],
    ...
    ideaPlaceholders: {
      ...
      qa: "例如：量子力学的基本原理是什么？",
      image: "例如：一只穿着印尼传统服饰的猫在海边冲浪，赛博朋克风格...",
    },
    genreLabel: "题材类型",
    copyTypeLabel: "文案类型",
    postLabel: "目标平台",
    ...
    imageTypes: ["1:1 正方形", "16:9 宽屏", "9:16 竖屏", "4:3 复古"],
    lengthLabel: "字数/质量",
    styleLabel: "风格",
    extraLabel: "额外要求（选填）",
    extraPlaceholder: "例如：语气活泼，或者绘图时增加胶片感...",
    lengths: [
      { v: "short", l: "短篇 / 标准" },
      { v: "medium", l: "中篇 / 高清" },
      { v: "long", l: "长篇 / 极速" },
    ],
    styles: ["正式严肃", "轻松幽默", "文艺感性", "犀利直接", "温暖治愈", "客观严谨", "写实摄影", "动漫插画", "数字艺术"],
    styleDefault: "不限风格",
    btnGenerate: "✨ 开始创作 / 绘图",
    btnStop: "⏹️ 停止生成",
    btnCopy: "复制全文",
    ...
    streaming: "正在疾速处理...",
    placeholder1: "在左侧输入你的想法或画面描述",
    placeholder2: "AI 将为你生成高质量作品",
    tags: ["灵感无限", "真实客观", "零成本绘图"],
    thinking: "AI 正在链接服务器并渲染内容...",
    errEmpty: "请输入你的想法、问题或画面描述",
    errFail: "生成失败：",
    errRetry: "请求失败，请稍后重试",
    errAborted: "⚠️ 创作已中止",
    lengthMap: { short: "500字左右", medium: "1500字左右", long: "3000字左右" },
    systemPrompts: {
      novel: "你是一位顶级小说作家，直接输出正文。",
      copy: "你是一位营销文案专家，直接输出正文。",
      script: "你是一位专业编剧，直接输出剧本。",
      post: "你是自媒体爆款专家，直接输出正文。",
      paper: "你是一位严谨的学术专家，直接输出论文正文。",
      qa: "你是一个百科全书专家，基于事实回答。",
    },
    userPrompts: {
      novel: (idea, sel, len, style, extra) => `创作小说：${idea}。题材：${sel}。篇幅：${len}。风格：${style}。要求：${extra}`,
      copy: (idea, sel, len, style, extra) => `写文案：${idea}。类型：${sel}。篇幅：${len}。风格：${style}。要求：${extra}`,
      script: (idea, sel, len, style, extra) => `写剧本：${idea}。类型：${sel}。风格：${style}。要求：${extra}`,
      post: (idea, sel, len, style, extra) => `写社媒内容：${idea}。平台：${sel}。要求：${extra}`,
      paper: (idea, sel, len, style, extra) => `写论文：${idea}。类型：${sel}。篇幅：${len}。要求：${extra}`,
      qa: (idea, sel, len, style, extra) => `问答：${idea}。风格：${style}`,
    },
    vipTag: "专业版",
    timeRemaining: "剩余时间"
  },
  tw: {
    name: "繁體中文", badge: "✦ AI創作工坊", title1: "一鍵生成", title2: "小說 · 論文 · 繪圖", subtitle: "輸入想法，AI幫你寫出完整內容",
    modeLabel: "創作類型",
    modes: [
    ...
    ideaPlaceholders: { novel: "例如：一個失憶偵探...", copy: "例如：主打成分護膚...", script: "例如：老友重逢...", post: "例如：效率翻倍...", paper: "例如：AI倫理...", qa: "例如：量子力學...", image: "例如：一隻貓在衝浪...", },
    genreLabel: "題材類型", copyTypeLabel: "文案類型", postLabel: "目標平台", paperLabel: "論文類型", qaLabel: "解答類型", imageLabel: "圖片比例",
    genres: ["言情", "懸疑", "玄幻", "都市", "歷史", "科幻"], copyTypes: ["產品推廣", "品牌故事"], postTypes: ["小紅書", "TikTok"], paperTypes: ["期末論文", "開題報告"], qaTypes: ["通俗科普", "專業解析"], imageTypes: ["1:1 正方形", "16:9 寬屏", "9:16 豎屏"],
    ...
    streaming: "正在處理...", placeholder1: "在左側輸入你的想法", placeholder2: "AI 將為你生成高品質作品", tags: ["靈感無限", "事實客觀"], thinking: "AI 正在構思...", errEmpty: "請輸入你的想法", errFail: "生成失敗：", errRetry: "請求失敗", errAborted: "⚠️ 創作已中止", lengthMap: { short: "500字", medium: "1500字", long: "3000字" },
    systemPrompts: { novel: "作家", copy: "策劃", script: "編劇", post: "專家", paper: "學術", qa: "百科" },
    userPrompts: { novel: (idea) => `創作小說：${idea}`, copy: (idea) => `創作文案：${idea}`, script: (idea) => `創作劇本：${idea}`, post: (idea) => `創作社媒：${idea}`, paper: (idea) => `撰寫論文：${idea}`, qa: (idea) => `回答問題：${idea}` },
    vipTag: "專業版", timeRemaining: "剩餘時間"
  },
  en: {
    name: "English", badge: "✦ AI Studio", title1: "Instant", title2: "Novel · Paper · Art", subtitle: "Enter ideas, AI writes or paints for you",
    modeLabel: "Content Type",
    modes: [
      { id: "novel", label: "📖 Story", desc: "Full Plot" }, { id: "copy", label: "✍️ Copy", desc: "Marketing" }, { id: "script", label: "🎬 Script", desc: "Scenes" }, { id: "post", label: "📱 Social", desc: "Instagram/TikTok" }, { id: "paper", label: "🎓 Essay", desc: "Academic" }, { id: "qa", label: "💬 Q&A", desc: "Factual" }, { id: "image", label: "🎨 Art", desc: "Flux Pro" }
    ],
    ideaLabel: "💡 Your Prompt *",
    ideaPlaceholders: { novel: "e.g. A detective...", copy: "e.g. Skin care...", script: "e.g. Old friends...", post: "e.g. Pomodoro...", paper: "e.g. AI ethics...", qa: "e.g. Relativity?", image: "e.g. A cat surfing...", },
    genreLabel: "Genre", copyTypeLabel: "Type", postLabel: "Platform", paperLabel: "Type", qaLabel: "Format", imageLabel: "Ratio",
    genres: ["Romance", "Mystery"], copyTypes: ["Ads", "Brand"], postTypes: ["TikTok", "Ins"], paperTypes: ["Thesis", "Report"], qaTypes: ["Deep", "Brief"], imageTypes: ["1:1 Square", "16:9 Wide", "9:16 Port"],
    lengthLabel: "Length", styleLabel: "Style", extraLabel: "Extra", extraPlaceholder: "e.g. Formal tone...",
    lengths: [ { v: "short", l: "Short" }, { v: "medium", l: "Medium" }, { v: "long", l: "Long" } ],
    styles: ["Formal", "Funny", "Realistic", "Anime"], styleDefault: "Any",
    btnGenerate: "✨ Generate", btnStop: "⏹️ Stop", btnCopy: "Copy All", btnCopied: "✓ Copied", btnDownload: "Save Image", resultLabel: "Result",
    resultLabels: { novel: "📖 Story", copy: "✍️ Copy", script: "🎬 Script", post: "📱 Post", paper: "🎓 Essay", qa: "💬 Answer", image: "🎨 AI Art" },
    streaming: "Processing...", placeholder1: "Enter your prompt", placeholder2: "AI will create high quality content", tags: ["Unlimited", "Professional"], thinking: "AI is thinking...", errEmpty: "Please enter idea", errFail: "Failed: ", errRetry: "Error, retry later", errAborted: "⚠️ Aborted", lengthMap: { short: "300 words", medium: "800 words", long: "1500 words" },
    ...
    vipTag: "PRO", timeRemaining: "Time Left"
  },
  id: {
    name: "Indonesia", badge: "✦ AI Studio", title1: "Buat", title2: "Teks · Esai · Foto", subtitle: "Masukkan ide, AI buat konten HD",
    modeLabel: "Jenis Konten",
    modes: [
      { id: "novel", label: "📖 Cerita", desc: "Alur Lengkap" }, { id: "copy", label: "✍️ Copy", desc: "Pemasaran" }, { id: "script", label: "🎬 Skrip", desc: "Dialog" }, { id: "post", label: "📱 Sosial", desc: "Insta/TikTok" }, { id: "paper", label: "🎓 Esai", desc: "Akademik" }, { id: "qa", label: "💬 Q&A", desc: "Tanya Jawab" }, { id: "image", label: "🎨 Foto", desc: "Flux Pro" }
    ],
    ideaLabel: "💡 Ide Anda *",
    ideaPlaceholders: { novel: "mis. Detektif...", copy: "mis. Serum...", script: "mis. Teman...", post: "mis. Teknik...", paper: "mis. Etika AI...", qa: "mis. Relativitas?", image: "mis. Kucing...", },
    genreLabel: "Genre", copyTypeLabel: "Jenis", postLabel: "Platform", paperLabel: "Jenis", qaLabel: "Format", imageLabel: "Rasio",
    genres: ["Romantis", "Misteri"], copyTypes: ["Iklan", "Brand"], postTypes: ["TikTok", "IG"], paperTypes: ["Skripsi", "Jurnal"], qaTypes: ["Dalam", "Singkat"], imageTypes: ["1:1 Kotak", "16:9 Lebar", "9:16 Tegak"],
    lengthLabel: "Panjang", styleLabel: "Gaya", extraLabel: "Ekstra", extraPlaceholder: "mis. Nada formal...",
    lengths: [ { v: "short", l: "Pendek" }, { v: "medium", l: "Sedang" }, { v: "long", l: "Panjang" } ],
    styles: ["Formal", "Lucu", "Realistis", "Anime"], styleDefault: "Bebas",
    btnGenerate: "✨ Mulai Buat", btnStop: "⏹️ Berhenti", btnCopy: "Salin Semua", btnCopied: "✓ Tersalin", btnDownload: "Simpan Gambar", resultLabel: "Hasil",
    resultLabels: { novel: "📖 Cerita", copy: "✍️ Copy", script: "🎬 Skrip", post: "📱 Postingan", paper: "🎓 Makalah", qa: "💬 Jawaban", image: "🎨 Karya AI" },
    streaming: "Memproses...", placeholder1: "Masukkan ide", placeholder2: "AI akan buat konten", tags: ["Kreatif", "Faktual"], thinking: "AI berpikir...", errEmpty: "Masukkan ide", errFail: "Gagal: ", errRetry: "Coba lagi", errAborted: "⚠️ Dihentikan", lengthMap: { short: "300 kata", medium: "800 kata", long: "1500 kata" },
...
function CopyBtn({ text, t }) {
  ...
  return (
    <button onClick={copy} style={{
      ...
      cursor: "pointer", border: "none", fontWeight: 500, display: "flex", alignItems: "center", gap: 6
    }}>
      {done ? <Check size={14} /> : <Copy size={14} />} {done ? t.btnCopied : t.btnCopy}
    </button>
  );
}
  ...
  return (
    <div style={{ background: S.bg, minHeight: "100vh", color: S.text, fontFamily: "system-ui, 'PingFang SC', 'Microsoft YaHei', sans-serif" }}>
      ...
      <div style={{ position: "fixed", top: 16, right: 16, zIndex: 100, display: "flex", gap: 10 }}>
        ...
        <button onClick={() => setShowLangMenu(!showLangMenu)} style={{ background: S.card, border: `1px solid ${S.border}`, color: S.text, padding: "8px 14px", borderRadius: 10, cursor: "pointer", fontSize: 13 }}>
      ...
      <div className="layout" style={{ maxWidth: 1100, margin: "0 auto", padding: "28px 16px 60px", display: "grid", gridTemplateColumns: "320px 1fr", gap: 16, minHeight: "100vh" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
              ...
              <div style={{ background: "rgba(251,191,36,0.1)", color: S.gold, fontSize: 10, padding: "4px 10px", borderRadius: 100, display: "flex", alignItems: "center", gap: 4 }}><ShieldCheck size={12} /> {t.vipTag}</div>
            </div>
          ...
          <div style={{ background: S.card, border: `1px solid ${S.border}`, borderRadius: 14, padding: 16, flex: 1, display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>{currentTags.map(tag => ( <Tag key={tag} label={tag} active={currentSel === tag} onClick={() => setCurrentSel(tag)} /> ))}</div>
            </div>
            ...
            {!loading ? (
              ...
              <button onClick={stopGeneration} style={{ width: "100%", padding: 14, marginTop: "auto", background: "rgba(239, 68, 68, 0.15)", border: `1px solid ${S.stop}`, borderRadius: 12, color: S.stop, fontSize: 15, fontWeight: 700, cursor: "pointer" }}>{t.btnStop}</button>
            )}
        ...
        <div className="right-panel" style={{ background: S.card, border: `1px solid ${S.border}`, borderRadius: 14, display: "flex", flexDirection: "column", overflow: "hidden", minHeight: 600 }}>
          <div style={{ padding: "14px 20px", borderBottom: `1px solid ${S.border}`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            {output && (
              <div style={{ display: "flex", gap: 10 }}>
                {mode === "image" ? (
                  <button onClick={() => window.open(output, '_blank')} style={{ background: "rgba(124,111,247,0.1)", color: S.accent, padding: "7px 18px", borderRadius: 8, fontSize: 13, cursor: "pointer", border: "none", display: "flex", alignItems: "center", gap: 6 }}><Download size={14} /> {t.btnDownload}</button>
                ) : (
          ...
          <div ref={outputRef} style={{ flex: 1, overflowY: "auto", padding: 24 }}>
            {!output && !loading && ( <div style={{ height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", color: S.muted, gap: 16 }}><div style={{ fontSize: 64, opacity: 0.15 }}>{mode === "image" ? "🎨" : "✍️"}</div><div style={{ textAlign: "center" }}>{t.placeholder1}<br/>{t.placeholder2}</div></div> )}
            {loading && mode !== "image" && !output && ( <div style={{ height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 }}><div style={{ width: 48, height: 48, border: `3px solid ${S.border}`, borderTopColor: S.accent, borderRadius: "50%", animation: "spin 0.8s linear infinite" }} /><div>{t.thinking}</div></div> )}
            {output && (
              <div style={{ lineHeight: 2, fontSize: 15 }}>
                {mode === "image" ? (
                  <div style={{ textAlign: "center" }}><img key={output} src={output} alt="AI Art" className="img-glow" style={{ maxWidth: "100%", borderRadius: 16 }} /><p style={{ marginTop: 20, color: S.muted }}>✨ Flux Pro Render Engine (Free)</p></div>
                ) : ( <div style={{ whiteSpace: "pre-wrap" }}>{output}{streaming && <span style={{ display: "inline-block", width: 2, height: "1em", background: S.accent, marginLeft: 2, animation: "pulse 0.8s infinite" }} />}</div> )}
              </div>
            )}
          </div>
        </div>
